...
class site_categoriserDockWidget(QDockWidget,FORM_CLASS):
    ...
    def initTopMenu(self):
        ...
        #processSecAct = processMenu.addAction('process section')
        #processSecAct.triggered.connect(self.processSec)
        #processAllAct = processMenu.addAction('process all sections')
        #processAllAct.triggered.connect(self.processAll)
...
#opens help/index.html in default browser
    ...
    def add(self):
        ...
        if sec and dd:
            dd.add_to_jc(sec,self.ch_tool.current_ch(),self.cat_combo.currentText())
